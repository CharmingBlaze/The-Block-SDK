...
@modeling-kit/input → @modeling-kit/math
...
@modeling-kit/paint → @modeling-kit/core, @modeling-kit/mesh, @modeling-kit/uv
...
@modeling-kit/selection → @modeling-kit/core, @modeling-kit/math, @modeling-kit/mesh
@modeling-kit/snapping → @modeling-kit/math, @modeling-kit/mesh
@modeling-kit/three-adapter → @modeling-kit/commands, @modeling-kit/core, @modeling-kit/document, @modeling-kit/math, @modeling-kit/mesh, @modeling-kit/rigging, @modeling-kit/selection, three (peer)
@modeling-kit/tools → @modeling-kit/core, @modeling-kit/input, @modeling-kit/mesh, @modeling-kit/snapping
...
@modeling-kit/workers → @modeling-kit/mesh, @modeling-kit/uv, @modeling-kit/validation
```
