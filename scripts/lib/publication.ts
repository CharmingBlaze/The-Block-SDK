...
export const PACKAGE_DESCRIPTIONS: Record<string, string> = {
  ...
  "@modeling-kit/formats": "glTF, OBJ, STL, PLY, and PPM interchange for modeling-kit",
  ...
  "@modeling-kit/uv": "UV islands, projections, packing, and automatic chart unwrap",
...
export const PACKAGE_KEYWORDS: Record<string, readonly string[]> = {
  ...
  "@modeling-kit/formats": ["3d", "gltf", "obj", "stl", "ply", "interchange", "typescript"],
